...
//Handles -l option when a directory is given.
void ls_l(char *f)
{
...
//Handles movment through directory helps ls_l
...
//ls on a directory without -l option
...
int main (int argc, char *argv[])
{
    ...
    if (strcmp(argv[1], "-l") == 0)
    {
       ...
       //user enters myls -l path/to/dir
       else if (argc == 3)
       {
    ...
    else
    {
       ...
       //Something incvalid entered ex: myls -r or myls -d file
